...
@Component({
  selector: 'ngx-supervisor-my-tasks',
  templateUrl: './supervisor-my-tasks.component.html',
  styleUrls: ['./supervisor-my-tasks.component.scss']
})
export class SupervisorMyTasksComponent implements OnInit {
  dropdownList = [];
  selectedItems = [];
